...
const file = '../../../../lib/resolvers/functions/build/Chat/members/members.js';

test('validate Chat members resolver', async () => {
  ...
  expect(result.query.expressionValues[":SK"].S).toEqual('MEMBER')
})